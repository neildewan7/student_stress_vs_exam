  ...
  ja: {
    ...
    visualization: {
      ...
      scoreChart: {
        title: "信号強度対試験スコア",
        description:
          "この散布図は、学生の平均生理学的信号レベル（EDAやHRなど）と試験での成績を相関させています。中間試験と期末試験のデータを切り替える���とができます。設計選択：ストレス指標と結果の間の可能な傾向を調査するために散布図を使用し、生理学的反応の高まりがより高いまたはより低い学業成績に関連するかどうかの探索を促進しています。",
        footnote:
