...
const translations = {
  ...
  ja: {
    ...
    stories: {
      title: "学生の軌跡物語",
      intro:
        "個��の学生の学期を通じた軌跡を追跡します。各物語は、ストレスパターンが学業成績と個人の回復力とどのように相関するかを明らかにします。",
      comeback: {
        title: "カムバック物語",
    ...
    visualization: {
      ...
      intro:
        "インタラクティブな可視化でデータを深く掘り下げます。異なる学生、試験タイプ、生理学的���号を比較できます。",
      hrChart: {
        title: "時間経過による心拍数",
        description:
    ...
    patterns: {
      ...
      results: {
        ...
        subtitle:
          "このパターンを示す学生を探索するには、任意のアーキタイプをクリ��クしてください：",
      },
      ...
      quiz: {
        ...
        intro:
          "いくつかの質問に��えて、あなたが最も示しやすいストレスパターンを発見してください：",
    ...
    insights: {
      ...
      heartRate: {
        title: "心拍数パターン",
        description:
          "心拍数は通常��試験の終盤近くでスパイクし、これ���時間的プレッシャーや最後の努力を反映している可能性があります。一部の学生は、すべての試��で一貫したパターンを示します。",
      },
      stressVariability: {
        title: "ストレス変動性",
        description:
    ...
    team: {
      title: "チームについて",
      description:
        "我々はデータストーリーテリングに情熱を持つ学生のグループです。このプロジェクトは、最終的な可視化コース課題の一��として共同で構築されました。",
    },
  },
};
