  ...
  ja: {
    ...
    stories: {
      ...
      steady: {
        ...
        analysis:
          "この学生は一貫性の力を示しています。劇的な変動ではなく、各試験サイクルを通じてパフォーマンスを��々に向上させながら、安定したストレスレベルを維持しました。",
        insights: [
          "一貫して中程度のストレスレベルを維持",
          "着実な改善を示した：78% → 82% → 91%",
          "一貫した準備の価値を実証",
    ...
    limitations: {
      ...
      list: [
        ...
        "動作アーティファクトや環境要因（例：室温）が信号精度に影響を与える可能性がありま��。",
