  ...
  ja: {
    ...
    visualization: {
      ...
      hrChart: {
        title: "時間経過による心拍数",
        description:
          "この線グラフは、試験中の学生の平均心拍数を示しています。性別グループでフィルタリングして、男女学生の傾向を観察できます。時間軸は3時間の試験時間をカバーし、ホバーすると���レベルのHR詳細が表示されます。設計選択：線グラフは、試験前の急上昇や中間点後の平坦化などのパターンを特定するための時間的傾向を示すのに効果的であるため選択されました。",
        student: "学生：",
        exam: "試験：",
        xAxisLabel: "試験時間（分）",
        yAxisLabel: "心拍数（BPM）",
