...
const translations = {
  ...
  ja: {
    ...
    overview: {
      title: "プロジェクト概要",
      description1:
        "このプロジェクトでは、中間試験と期末試験中��収集されたウェアラブルセンサーのデータを分析することで、学業ストレスと生理的反応の関係を探ります。我々の目標は、心拍数（HR）や皮膚電気活動（EDA）などの測定可能な信号を通じて、認知的プレッシャーがリアルタイムでどのように現れるかを明らかにすることです。この研究は、学業プレッシャーの見えない負担を明らかにし、ストレスが個人や状況によってどのように変化するかについての洞察を提供します。",
      description2:
    ...
    stories: {
      ...
      steady: {
        ...
        description:
          "学生S01は着実で一貫した改善の典型例です。彼らのアプローチは、体系的な準備と一貫したストレスレベルが段階的だが信頼できる学業成長に���ながることを示しています。",
        analysis:
    ...
    patterns: {
      ...
      insights: {
        ...
        clusteringDesc:
          "類似のストレスパターンを持つ学生は、しばしば異なるパフォーマンス結果を示し、ス��レスが成績を予測しないことを確認しています。",
    ...
    insights: {
      ...
      individualDifferences: {
        title: "個人差",
        description:
          "生理学的反応は、試験タイプよりも個人によってより多く変動し、個人のストレス閾値と対��戦略を強調しています。",
      },
      realityCheck: {
        title: "現実チェック",
        description:
