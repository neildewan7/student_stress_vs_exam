  ...
  ja: {
    ...
    patterns: {
      ...
      insights: {
        ...
        personalizationDesc:
          "あなたのスト��スアーキタイプを理解することで、個人に合わせたストレス管理戦略の開発に役立つ可能性があります。",
      },
      quiz: {
    ...
    methods: {
      title: "データセットと方法論",
      description:
        "���々は、実際の大学試験中に収集された心拍数（HR）と皮膚電気活動（EDA）の連続記録を含む、PhysioNetから公開��れているウェアラブル試験ストレスデータセットを使用しました。",
      steps: "データ処理ステップ��は以下が含まれます：",
      stepList: [
