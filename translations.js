...
const translations = {
  ...
  ja: {
    ...
    visualization: {
      ...
      intro:
        "インタラ���ティブな可視化でデータを深く掘り下げます。異なる学生、試験タイプ、生理学的信号を比較できます。",
      hrChart: {
        title: "時間経過による心拍数",
        description:
      ...
      scoreChart: {
        title: "信号強度対試験スコア",
        description:
          "この散布図は、学生の平均生理学的信号レベル（EDAやHRなど）と試験での成績を相関させています。中間試験と期末試験のデータを切り替えることができます。設計選択：ストレス指標と結果の間の可能な傾向を調査するために散布図を使用し、生理学��反応の高まりがより高いまたはより低い学業成績に関連するかどうかの探索を促進しています。",
        footnote:
    ...
    patterns: {
      ...
      quiz: {
        ...
        intro:
          "いくつかの質問に答えて、あなたが最も示しや��いストレスパターンを発見してください：",
    ...
    insights: {
      ...
      stressVariability: {
        title: "ストレス変動性",
        description:
          "女子学生は期��試験中にEDAでより多くの変動性を示し、性別間で異なるストレス対処メカニズムを示唆しています。",
      },
      individualDifferences: {
        title: "個人差",
        description:
